...
const taskDetailsData = {
    ...
    'task2-1-2': {
        ...
        subcategory: 'LTV/PLM 기반의 상품/서비스 체계 재설계',
        organization: 'Product&Brand본부',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
            monthly: {
                target: ['-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-'],
                actual: ['-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-', '-']
    ...
    'task2-2-1': {
        ...
        category: 'LTV',
        subcategory: 'LTV 모델에 상품/혜택 등 다양한 변수 input 및 개인화 수준까지 고도화',
    ...
    'task2-3-1': {
        ...
        category: 'LTV',
        subcategory: 'AI LTV 모델 활용 상품 offering 全 단계에 AI 도입',
        organization: 'Sales&Marketing본부',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task2-4-1': {
        ...
        category: 'LTV',
        subcategory: '[Enterprise] 수익성 중심 포트폴리오 재편 및 高 ARPU Enterprise 시장 공략',
    ...
    'task3-1-1': {
        title: '결합 할인 revisit',
        category: '마케팅 효율',
        subcategory: '기대 매출 대비 과한 비용이 투입되고 있는 결합고객의 비용구조 개선',
        organization: 'Product&Brand본부',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task3-2-1': {
        ...
        category: '마케팅 효율',
        subcategory: '고객 그룹별 기여가치 고려한 RAC 차등',
        organization: 'Sales&Marketing본부',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task3-4-1': {
        ...
        category: '마케팅 효율',
        subcategory: '고객 LTV와 align하여 혜택/서비스의 차등 관리',
        organization: 'Product&Brand본부',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task3-5-1': {
        ...
        category: '마케팅 효율',
        subcategory: '사람이 처리중인 고객 응대 업무를 AI로 단계적 자동화',
        organization: 'MNO AT/DT기획담당',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task4-1-1': {
        ...
        category: '인당 네트워크 운영 비용',
        subcategory: '생산성 고려한 Network 개선',
    ...
    'task4-2-1': {
        ...
        category: '인당 네트워크 운영 비용',
        subcategory: 'AI-based 비용 분석 기반 파트너십/임차료 관련 SCM 구조 개선',
        organization: 'Network센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task4-3-1': {
        ...
        category: '인당 네트워크 운영 비용',
        subcategory: 'AI 기반 분석을 통한 유지보수 관련 SCM 최적화',
        organization: 'Network센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task4-4-1': {
        ...
        category: '인당 네트워크 운영 비용',
        subcategory: '네트워크 도메인 별 특화된 AI agent 활용 가속화로 생산성 혁신',
        organization: 'Network센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task5-1-1': {
        ...
        category: '체감 품질 기준 만족률',
        subcategory: '권역 관리를 넘어, LTV와 AI 기반 체감 품질 기준 optimization',
        organization: 'Network센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task6-1-1': {
        ...
        category: '직원당 생산성',
        subcategory: 'AI 자동화를 통한 업무 생산성 제고',
        organization: 'Network센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task7-1-1': {
        ...
        category: '보안',
        subcategory: '[N/W] 보안 투자 확대 및 보안에 강한 Network 구현',
        organization: 'Network센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task7-2-1': {
        ...
        category: '보안',
        subcategory: '[N/W] 보안 신뢰성 확보를 위한 외부 관점의 보안 점검/진단 강화',
        organization: 'AT/DT센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task7-3-1': {
        ...
        category: '보안',
        subcategory: '[IT, N/W] 자산 통합관리체계 구축으로 자산 투명성 확보 및 보안성 강화',
        organization: 'AT/DT센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task8-1-1': {
        ...
        category: 'SHE',
        subcategory: '[N/W] 관리 사각지대 개선을 위한 통합 SHE 관리체계 upgrade (자회사, BP 포함)',
        organization: '안전보건실',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task9-1-1': {
        ...
        category: '안정운용',
        subcategory: '[N/W] 대형고장 원천 차단을 위한 네트워크 안정운용 체계 구축',
        organization: 'Network센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task9-2-1': {
        ...
        category: '안정운용',
        subcategory: '[N/W] AT/DT를 활용한 안정운용 체계 고도화',
        organization: 'Network센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task9-3-1': {
        ...
        category: '안정운용',
        subcategory: '[IT] 장애 대응력 강화를 위한 관리 시스템 고도화 추진',
        organization: 'AT/DT센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
    ...
    'task10-2-1': {
        ...
        category: 'AT/DT',
        subcategory: 'AI readable data 구축',
        organization: 'AT/DT센터',
        task: '과제 상세 내용은 추후 업데이트 예정입니다.',
        target: '지표 정의 및 산출 로직은 추후 업데이트 예정입니다.',
        milestone: {
...
// localStorage에서 상세 데이터 로드
function loadDetailDataFromStorage() {
    try {
        const storedData = localStorage.getItem('mno_dashboard_data');
        if (storedData) {
            const parsed = JSON.parse(storedData);
            if (parsed.taskDetails && typeof parsed.taskDetails === 'object') {
                Object.assign(taskDetailsData, parsed.taskDetails);
                console.log('localStorage에서 상세 데이터를 로드했습니다.');
            }
        }
    } catch (error) {
        console.warn('localStorage 상세 데이터 로드 실패, 기본 데이터 사용:', error);
    }
}
